...
namespace expose {
    ...
    void radiation() {
        ...
        class_<RadiationCalculator>("RadiationCalculator",
            ...
            .def("net_radiation_step",&RadiationCalculator::net_radiation_step,(py::arg("self"),py::arg("response"), py::arg("latitude"), py::arg("t1"),py::arg("t2"), py::arg("slope"), py::arg("aspect"), py::arg("temperature"), py::arg("rhumidity"), py::arg("elevation"),  py::arg("rsm")),
                     doc_intro("calculates net radiation, updating response")
            )
            ;
    }
